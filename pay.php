...
if (isset($_GET['plan'])) {
  ...
  if (isset($_POST['pay'])) {
    ...
    $role=1;
    $update = "UPDATE `user` SET `plan_id`='$plan_id' , `role_id`='$role' WHERE `user_id`=$user_id";
...
<body>
  ...
  <div class="visa-container">
    ...
    <div class="rest-visa" id="mainDiv">
      <div class="container">
        ...
        <div class="payment">
          ...
          <form method="POST" class="form">
            ...
            <button name="pay" type="submit" class="form__btn">Confirm</button>
